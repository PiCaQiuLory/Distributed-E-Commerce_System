...
<body class="easyui-layout">
    <!-- 头部标题 -->
	<div data-options="region:'north',border:false" style="height:60px; padding:5px; background:gray"> 
		<span class="northTitle" style="font-family: 楷体;color:white;">武侯阁商城后台</span>
	    <span class="loginInfo" style="font-family: 楷体;color:white;">登录用户：admin&nbsp;&nbsp;姓名：管理员&nbsp;&nbsp;角色：系统管理员</span>
	</div>
